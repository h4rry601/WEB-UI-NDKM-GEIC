...
function UploadIcon({ size = 24, color = '#000' }: UploadIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M7 10L12 5L17 10" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
      <path d="M12 5V15" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    </svg>
  )
}
